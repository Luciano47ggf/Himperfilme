...
export default function Footer() {
  ...
  return (
    <footer className="border-t border-brand-hairline bg-brand-black px-5 py-12 sm:px-8">
      ...
      <div className="mx-auto mt-10 max-w-6xl border-t border-brand-hairline pt-6 text-center">
